...
from odoo.addons.pos.tests.test_pos.order import TestPosOrder


class TestPosExceptionMultiRecord(TestPosOrder):
    ...
    def test_pos.order_exception(self):
        exception_no_sol = self.env.ref('pos.exception.excep_no_sol')
        exception_no_free = self.env.ref('pos.exception.excep_no_free')
        exception_no_dumping = self.env.ref('pos.exception.excep_no_dumping')
        exceptions = (
            exception_no_sol +
            exception_no_free +
        ...
        self.env['pos.order'].test_all_draft_orders()
        ...
        # it should still be present on the pos.order
